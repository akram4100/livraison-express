  ...
  return (
    <div className={`dashboard-container ${darkMode ? "dark" : ""}`}>
      ...
      <div className="dashboard-content">
        ...
        >
          <button className="action-btn">➕ {t("new_order")}</button>
          <button className="action-btn">📋 {t("order_history")}</button>
          <button className="action-btn">👤 {t("my_profile")}</button>
        </motion.div>
      </div>
    </div>
  );
